                    ...
                    if (slot == count) {
                      ...
                      new Applications({
                        ...
                        `;
                                ...
                                sendEmailNotification('sales@homeclassgroup.com',subject, adminMsg)
...
// fetch unpaid invoices. i.e fetch application that amount1status, amount2status = 0
...
// fetch unpaid invoices. i.e fetch application that amount1status=>2
